...
class Server(AbstractBase):
    ...
    allow_scheduled_runs = db.Column(Boolean, default=True)
    allow_rest_api_runs = db.Column(Boolean, default=True)
    allow_application_runs = db.Column(Boolean, default=True)
