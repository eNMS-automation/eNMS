...
class NapalmForm(ConnectionForm):
    ...
    driver = SelectField(
        choices=[
            ("device", "Use Device Driver"),
            *((driver, driver) for driver in vs.napalm_drivers),
        ],
    )
...
class NetmikoForm(ConnectionForm):
    ...
    driver = SelectField(
        choices=[
            ("device", "Use Device Driver"),
            *((driver, driver) for driver in vs.netmiko_drivers),
        ],
    )
...
class ScrapliForm(ConnectionForm):
    ...
    driver = SelectField(
        choices=[
            ("device", "Use Device Driver"),
            *((driver, driver) for driver in vs.scrapli_drivers),
        ],
    )
