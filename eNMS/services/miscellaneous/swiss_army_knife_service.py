...
class SwissArmyKnifeService(Service):
    ...
    def mail_feedback_notification(self, run: "Run", payload):
    ...
    def slack_feedback_notification(self, run: "Run", payload):
    ...
    def mattermost_feedback_notification(self, run: "Run", payload):
        post(
            app.mattermost_url,
    ...
    def cluster_monitoring(self, run: "Run", payload):
    ...
    def poller_service(self, run: "Run", payload):
    ...
    def git_push_configurations(self, run: "Run", payload):
    ...
    def process_payload1(self, run: "Run", payload, device: Device):
