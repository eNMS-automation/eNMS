...
class Device(CustomDevice):
    ...
    configuration = Column(LargeString, info={"dont_track_changes": True, "model_properties": False})
    operational_data = Column(LargeString, info={"dont_track_changes": True, "model_properties": False})
