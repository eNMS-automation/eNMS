...
class PayloadExtractionService(Service):
    ...
    variable1 = Column(SmallString, default="")
    query1 = Column(SmallString, default="")
    match_type1 = Column(SmallString, default="none")
    match1 = Column(LargeString, default="")
    variable2 = Column(SmallString, default="")
    query2 = Column(SmallString, default="")
    match_type2 = Column(SmallString, default="none")
    match2 = Column(LargeString, default="")
    variable3 = Column(SmallString, default="")
    query3 = Column(SmallString, default="")
